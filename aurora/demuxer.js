...
const ID3v23Stream = require("./id3").ID3v23Stream;
const ID3v22Stream = require("./id3").ID3v22Stream;
const MP3FrameHeader = require("./header");
const MP3Stream = require("./stream");

const MP3Demuxer = AV.Demuxer.extend(function() {
  ...
  this.prototype.parseDuration = function(header, off) {
    ...
    this.emit(
      "duration",
      (((frames * header.nbsamples() * 32) / header.samplerate) * 1000) | 0
    );
    return true;
  };
