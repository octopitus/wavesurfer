  ...
  huffmanDecode(stream, xr, channel, sfbwidth, part2_length) {
    ...
    while (big_values-- && cachesz + bits_left > 0) {
      ...
      if (linbits) {
        ...
        if (x_final) {
          xr[xrptr] =
            bitcache & (1 << (cachesz-- - 1)) ? -requantized : requantized
        }
